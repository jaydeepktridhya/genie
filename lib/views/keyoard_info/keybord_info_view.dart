...
import 'keyboard_info_controller.dart';

class KeyboardInfoView extends GetView<KeyboardInfoController> {
  KeyboardInfoView({Key? key}) : super(key: key);
  final KeyboardInfoController infoController =
      Get.put(KeyboardInfoController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: KeyboardInfoController(),
        builder: (KeyboardInfoController controller) {
          return Container(
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    WidgetSpan(
                      child: SvgPicture.asset(
                        infoController.isKeyboardEnabled.value
                            ? ImagePath.icCheckGreen
                            : ImagePath.icWarning,
                        color: infoController.isKeyboardEnabled.value
                            ? green71
                            : red6D,
                        width: 24,
                        height: 24,
                    ...
                    TextSpan(
                      text: infoController.isKeyboardEnabled.value
          ...
          20.verticalSpace,
          Visibility(
            visible: !infoController.isKeyboardEnabled.value,
            child: Column(
              children: [
                Text(
