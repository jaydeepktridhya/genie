...
fun Context.getButtonBackgroundColor() = if (isDarkThemeOn()) {
    ContextCompat.getColor(this, R.color.white)
} else {
    ContextCompat.getColor(this, R.color.black)
}
fun Context.getAttributeColor() = if (isDarkThemeOn()) {
    ContextCompat.getColor(this, R.color.keyboard_bg_attribute_color)
} else {
    ContextCompat.getColor(this, R.color.black)
}
...
fun Context.getActionIconColor() = if (isDarkThemeOn()) {
    ContextCompat.getColor(this, R.color.system_accent1_10)
} else {
    ContextCompat.getColor(this, R.color.system_accent1_900)
}
