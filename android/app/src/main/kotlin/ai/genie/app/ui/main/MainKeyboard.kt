...
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_DELETE
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_EMOJI
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_ENTER
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_MODE_CHANGE
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_SHIFT
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.KEYCODE_SPACE
import ai.genie.app.ui.main.ItemMainKeyboard.Companion.MAX_KEYS_PER_MINI_ROW
...
class MainKeyboard @JvmOverloads constructor(
    ...
    override fun onVisibilityChanged(changedView: View, visibility: Int) {
        ...
        if (visibility == VISIBLE) {
            ...
            val miniKeyboardBackgroundColor =
                ContextCompat.getColor(context, R.color.you_keyboard_background_color)
    ...
    private fun onBufferDraw() {
        ...
        canvas.drawColor(R.color.you_background_color, PorterDuff.Mode.CLEAR)
        ...
        for (i in 0 until keyCount) {
            ...
            when (code) {
                ...
                KEYCODE_MODE_CHANGE -> {
                    keyBackground =
                        resources.getDrawable(R.drawable.keyboard_bg_left_action, context.theme)
                }
                KEYCODE_DELETE -> {
                    keyBackground =
    ...
    private fun onLongPress(popupKey: ItemMainKeyboard.Key, me: MotionEvent): Boolean {
        ...
        if (popupKeyboardId != 0) {
            ...
            invalidateAllKeys()
            return true
        } else if (mKeys[mCurrentKey].code == KEYCODE_SPACE) {
            val imeManager =
