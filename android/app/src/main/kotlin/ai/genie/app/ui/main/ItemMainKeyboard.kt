...
class ItemMainKeyboard {
    ...
    companion object {
        ...
        const val SHOW_POPUP_ON_KEYPRESS = false
                            ...
                            if (key.code == KEYCODE_ENTER) {
                                val enterResourceId = when (mEnterKeyType) {
                                    ...
                                    EditorInfo.IME_ACTION_NEXT, EditorInfo.IME_ACTION_GO -> {
                                        R.drawable.ic_keyboard_send_white
                                    }
                                    EditorInfo.IME_ACTION_SEND, EditorInfo.IME_ACTION_DONE -> R.drawable.ic_keyboard_done
